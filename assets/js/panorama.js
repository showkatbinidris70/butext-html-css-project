...
if (!lotameIsCompatible()) {
  ...
  function sync16621_b(a) {
    ...
    return b ? b.call(a) : { next: sync16621_a(a) };
  }
  var sync16621_aa =
  ...
  if ("function" == typeof Object.setPrototypeOf)
    sync16621_c = Object.setPrototypeOf;
  else {
    var sync16621_d;
    a: {
      var sync16621_ba = { Sa: !0 },
        sync16621_e = {};
      try {
      ...
      "function" == typeof Object.assign
        ...
        : function (a, b) {
            for (var c = 1; c < arguments.length; c++) {
              var d = arguments[c];
              if (d) for (var f in d) sync16621_i(d, f) && (a[f] = d[f]);
            }
            return a;
          },
    sync16621_j =
  ...
  function sync16621_k(a, b) {
    if (b) {
      ...
      b != d &&
        null != b &&
        sync16621_j(c, a, { configurable: !0, writable: !0, value: b });
    }
  }
  ...
  function sync16621_n() {
    ...
    a ||
      (a = sync16621_h.Symbol.iterator = sync16621_h.Symbol("Symbol.iterator"));
    "function" != typeof Array.prototype[a] &&
      sync16621_j(Array.prototype, a, {
        configurable: !0,
        writable: !0,
        value: function () {
    ...
    f.prototype.delete = function (e) {
      ...
      return e.g && e.list
        ? (e.list.splice(e.index, 1),
          e.list.length || delete this.S[e.id],
          (e.g.w.next = e.g.next),
          (e.g.next.w = e.g.w),
          (e.g.head = null),
          this.size--,
  ...
  sync16621_k("Promise", function (a) {
    ...
    b.prototype.pa = function () {
      ...
      var e = this,
        k = !1;
      return { resolve: g(this.cb), reject: g(this.ra) };
    };
    b.prototype.cb = function (g) {
      if (g === this)
        this.ra(new TypeError("A Promise cannot resolve to itself"));
    ...
    b.race = function (g) {
      return new b(function (e, k) {
        for (var l = sync16621_b(g), m = l.next(); !m.done; m = l.next())
          d(m.value).Y(e, k);
      });
    };
    b.all = function (g) {
  ...
  function sync16621_ea() {
    ...
    do {
      ...
      b.H("lotame_domain_check") === f
        ? (f = !1)
        : ((d += -1), (f = Math.abs(d) <= c.length));
    } while (f);
    return a;
  }
  ...
  sync16621_t.prototype.Z = function () {
    return { tp: sync16621_u(this) ? this.B : void 0 };
  };
      ...
      (b = !1),
        a && sync16621_x(a)
          ? "undefined" === typeof a.id || "undefined" === typeof a.type
            ...
            : sync16621_v.includes(a.type)
            ? "EMAIL" != a.type || sync16621_ga.test(a.id)
              ? (b = !0)
              : sync16621_.error(
          ...
          : sync16621_.error("Declared ID should be an object");
    b && (this.h = a);
  }
  ...
  function sync16621_ia(a, b) {
    if (b) {
      var c = !0;
      "object" != typeof b &&
        sync16621_.error("tagInput.data.behaviors should be an object");
      for (
        var d = sync16621_b(Object.entries(b)), f = d.next();
        !f.done;
        f = d.next()
      ) {
  ...
  function sync16621_ja(a, b) {
    if (b) {
      for (
        var c = !0, d = sync16621_b(Object.entries(b)), f = d.next();
        !f.done;
        f = d.next()
      ) {
        var h = sync16621_b(f.value);
  ...
  sync16621_w.prototype.u = function () {
    return (
      !(this.j && 0 < this.j.length) &&
      !sync16621_y(this) &&
      !sync16621_z(this) &&
      !sync16621_A(this) &&
      sync16621_t.prototype.u.call(this)
    );
  };
  ...
  function sync16621_J(a, b, c, d) {
    a.I(
      b,
      c,
      void 0 === d ? a.da : Math.ceil((d - new Date().getTime()) / 1e3)
    );
    sync16621_K(a, b, c, d);
  }
  ...
  function sync16621_K(a, b, c, d) {
    a.qa &&
      ...
      void 0 !== d && window.localStorage.setItem(b + a.ca, String(d)));
  }
  function sync16621_L(a, b) {
    a.qa &&
      (window.localStorage.removeItem(b),
      window.localStorage.removeItem(b + a.ca));
  }
  ...
  function sync16621_la(a, b) {
    return a.qa &&
      ((a = window.localStorage.getItem(b + a.ca)),
  ...
  sync16621_G.prototype.F = function () {
    return this.f.a.panoramaIdEnabled
      ? sync16621_I(this, this.f.a.panoramaIdName)
      : null;
  };
  function sync16621_na(a) {
    return a.f.a.panoramaIdEnabled
      ? sync16621_I(a, a.f.a.panoramaIdTypeName)
      : null;
  }
  function sync16621_M(a, b) {
    this.f = a;
  ...
  function sync16621_O(a, b) {
    ...
    if ((b = a.aud))
      Array.isArray(b)
        ? (this.ea = b)
        : sync16621_.error("profileData.audienceIds should be an array");
    if ((b = a.pid))
      "string" !== typeof b
        ? sync16621_.error(
    ...
    if ((b = a.tc))
      Array.isArray(b)
        ? (this.la = b)
        : sync16621_.error("profileData.targetingCodes should be an array");
    (b = a.spx) &&
      !Array.isArray(b) &&
      sync16621_.error("profileData.syncPixels should be an array");
    if ((b = a.e))
      Array.isArray(b)
        ? ((this.V = b), Array.isArray(b) && b.forEach(this.Pa))
        : sync16621_.error("profileData.errorCodes should be an array");
    (b = a.exb) &&
      !Array.isArray(b) &&
      sync16621_.error("profileData.exportBeaconIds should be an array");
  ...
  function sync16621_ta(a) {
    ...
    b
      ? ((b = b.t),
        (b = null == b ? null : (b = sync16621_oa.get(b)) ? b : "UNKNOWN"))
      : (b = null);
    ...
    if (a && sync16621_x(a)) {
      ...
      a && sync16621_x(a)
        ? "undefined" === typeof a.id || "undefined" === typeof a.type
          ...
          : sync16621_ya.includes(a.type)
          ? "EMAIL" != a.type || sync16621_xa.test(a.id)
            ? (b = !0)
            : sync16621_.error(
        ...
        : sync16621_.error("id should be an object");
  ...
  function sync16621_0(a) {
    var b = Object.assign({}, a.l, sync16621_Ba(a)),
      c = Object.assign(
        {},
        { ref: a.ha, pv: a.ua, dcc: a.fa, co: a.na, src: a.ka },
        sync16621_Ca(a)
      );
    return Object.assign(
      { r: { rpr: a.za, rpx: a.ja, rid: a.ia }, m: c, d: b, c: a.J },
      sync16621_Da(a)
    );
  }
  function sync16621_Ea(a) {
    var b = Object.assign({}, a.l, sync16621_Ba(a)),
      c = Object.assign({}, { dcc: a.fa, src: a.ka }, sync16621_Ca(a));
    return Object.assign(
      { r: { rid: a.ia }, m: c, d: b, c: a.J },
      sync16621_Da(a)
    );
  }
  ...
  function sync16621_1(a) {
    return (
      "object" === typeof a.h ||
      ("object" === typeof a.l && "object" === typeof a.l.did)
    );
  }
  function sync16621_Da(a) {
    ...
    return b || c
      ...
      : d
      ? { consent: { us_privacy: d ? a.ma : null } }
      : {};
  }
    ...
    if ("undefined" !== typeof window.__tcfapi) {
      var b = function (c, d) {
        d &&
          ...
          (c.tcString && "string" == typeof c.tcString && (a.K = c.tcString),
          c.gdprApplies &&
            "boolean" == typeof c.gdprApplies &&
            (a.o = c.gdprApplies));
      };
      try {
        ...
        c &&
          sync16621_.debug(
            "Call to deprecated getTCData method returned error: " + c
          );
      }
      try {
  ...
  sync16621_4.prototype.O = function () {
    var a = this;
    "undefined" !== typeof window.__uspapi
      ? (window.__uspapi("registerDeletion", 1, function (b) {
          ...
          d = sync16621_V(
            sync16621__(
              sync16621_Z(
                sync16621_X(sync16621_Y(d, b.G.o), sync16621_3(b.G)),
                sync16621_5(b.ba)
              ),
              b.f.a.source
            ),
            ...
            sync16621_Y(
              sync16621_W(
                sync16621_V(
                  sync16621_S(
                    sync16621_U(
                      sync16621_T(new sync16621_R(), a.f.a.bcpClient),
                      !0
                    ),
                    !1
                  ),
  ...
  function sync16621_Ia(a, b, c) {
    ...
    c = sync16621__(
      sync16621_Z(
        sync16621_X(
          sync16621_Y(sync16621_W(sync16621_V(d, a.storage.M()), c), a.G.o),
          sync16621_3(a.G)
        ),
        sync16621_5(a.ba)
      ),
  ...
  function sync16621_6(a, b) {
    if (
      ...
      a: {
        a = a.storage;
        if ((a = sync16621_la(a, a.f.a.declaredIdName)))
          try {
  ...
  function sync16621_Ma(a, b) {
    ...
    this.storage = b;
    sync16621_.Fa &&
      sync16621_.debug("Google Esp Module Enabled: " + this.enabled);
    !0 === this.enabled &&
      ((window.googletag = window.googletag || { cmd: [] }),
      (window.googletag.encryptedSignalProviders =
        window.googletag.encryptedSignalProviders || []),
      (a = this.storage.F()) && sync16621_Na(this, a));
  }
  ...
  function sync16621_Pa(a, b) {
    ...
    if ((d = (c = sync16621_P(b)) ? c.e : null)) {
      ...
      "string" === typeof f && f
        ? sync16621_J(a.storage, g, f, e)
        : ((d = a.storage), d.I(g, "", 0), sync16621_L(d, g));
      "string" === typeof h && h && "UNKNOWN" !== h
        ? sync16621_J(a.storage, c, h, e)
        : ((d = a.storage), d.I(c, "", 0), sync16621_L(d, c));
    }
    a.f.a.enableDeclaredIds &&
      a.f.a.enableDeclaredIdsOnEvents &&
      (b = sync16621_ua(b)) &&
  ...
  sync16621_Ra.prototype.sync = function (a) {
    var b = this,
      ...
      d = void 0;
    d =
      sync16621_x(a) && !sync16621_B(a)
        ? new sync16621_t(a)
        : new sync16621_t();
    if (d.u())
      if (this.f.a.panoramaIdEnabled) {
        if (
          ((a = sync16621_I(this.storage, this.f.a.panoramaIdName + "_expiry")),
        ...
        (a = sync16621_H(this.storage)),
          (f = sync16621_I(this.storage, this.f.a.lastProfileUpdateMillisKey)),
          a &&
            f &&
            Date.now() - this.f.a.profileRefreshMillis < f &&
            (sync16621_$(this.L, new sync16621_O({ pid: a }, this.f)),
            (c = !1));
    c &&
      sync16621_Ja(this.Ea, d, function (h) {
        sync16621_K(
          b.storage,
        ...
        sync16621_Pa(b.L, h);
        sync16621_wa(h)
          ? sync16621_.error("Aborting due to above errors.")
          : sync16621_Na(b.Ya, b.storage.F());
        sync16621_$(b.L, h);
      });
  };
