...
*/
  ...
  var Yqb = function (a) {
    ...
    $qb = function (a) {
      d5.push({ name: a.N6 ? a.name + " (" + a.N6 + ")" : a.name, bA: !!a.bA });
    },
    e5 = function () {
      var a, b;
      return null != (b = null == (a = d5[d5.length - 1]) ? void 0 : a.bA)
        ? b
        : !1;
    },
    brb = function (a) {
      ...
      try {
        ...
        throw ((a = c), arb(a, [].concat(g.qa(b), g.qa(d5))), d5.pop(), a);
      }
    },
    arb = function (a, b) {
      0 === b.length ||
    ...
    g5 = function (a, b) {
      ...
      b = nrb(a, c, 1 === a.nodeType ? d || b : null);
    ...
    orb = function (a, b, c, d, e) {
      return b == c && d == e;
    },
    k5 = function (a) {
      for (var b = h5, c = i5(); c !== a; ) {
        var d = c.nextSibling;
        b.removeChild(c);
        j5.j.push(c);
        c = d;
    ...
    i5 = function () {
      return l5 ? l5.nextSibling : h5.firstChild;
    },
    prb = function (a, b) {
      l5 = i5();
      var c;
      ...
      c ||
        ("#text" === a
          ? ((a = n5.createTextNode("")), nrb(a, "#text", null))
          : ((c = n5),
            (d = h5),
            "function" === typeof a
              ? (c = new a())
      ...
      if (a !== l5) {
        if (0 <= o5.indexOf(a))
          for (b = h5, c = a.nextSibling, d = l5; null !== d && d !== a; )
            (e = d.nextSibling), b.insertBefore(d, c), (d = e);
        else h5.insertBefore(a, l5);
        l5 = a;
      }
    },
    qrb = function (a, b) {
    ...
    srb = function (a, b) {
      b = void 0 === b ? {} : b;
      var c = void 0 === b.matches ? orb : b.matches;
    ...
    Brb = function (a, b) {
      u5(b);
      if (a && void 0 !== a.vk && void 0 !== a.Cr && void 0 !== a.dB) {
        if (zrb(a)) for (b = a.lQ; b < a.vk.length; b++) Arb(a.vk[b], a.Cr[b]);
        for (; a.vk.length > a.lQ; ) a.vk.pop(), a.dB.pop(), a.Cr.pop();
      }
    },
    Crb = function (a) {
      w5(a);
      for (var b = 0; b < a.vk.length; b++) {
        ...
        if (!zrb(c) || c.Zl)
          if (c.Zl || 1 !== c.HY)
            (c.K_(c) || Crb(c)) && c.L_(c), (c.Zl = !1), (c.HY = 1);
        if (d !== c.version) return !0;
      }
      return !1;
    },
    Arb = function (a, b) {
      ...
      w5(a);
      if (1 === a.Zj.length)
        for (var c = 0; c < a.vk.length; c++) Arb(a.vk[c], a.Cr[c]);
      c = a.Zj.length - 1;
      a.Zj[b] = a.Zj[c];
      a.Ew[b] = a.Ew[c];
      a.Zj.length--;
      a.Ew.length--;
      b < a.Zj.length && ((c = a.Ew[b]), (a = a.Zj[b]), w5(a), (a.Cr[c] = b));
    },
    zrb = function (a) {
      var b, c;
      return (
        ...
        0 <
          (null !=
          (c = null == a ? void 0 : null == (b = a.Zj) ? void 0 : b.length)
            ? c
            : 0)
      );
    },
      ...
      e.jB =
        ...
        (a.destroy = function () {
          if (null !== e.Qs || null !== e.schedule) {
            w5(e);
            if (zrb(e))
              for (var f = 0; f < e.vk.length; f++) Arb(e.vk[f], e.Cr[f]);
            e.vk.length = e.dB.length = e.Cr.length = 0;
            e.Zj && (e.Zj.length = e.Ew.length = 0);
            e.Ry();
            e.Qs = null;
            e.schedule = null;
            e.Ry = Erb;
    ...
    Erb = function () {},
    Hrb = function (a) {
      return Object.create(Object.assign({}, x5, { GN: a }));
    },
    y5 = function (a, b) {
      a = u5(a);
      try {
    ...
    Krb = function (a) {
      var b = s5;
      b && !b.Ma && (b.tF || (b.tF = []), b.tF.push(a));
    },
    Mrb = function (a) {
      var b;
      null == (b = a.tF) || b.forEach(Jrb);
      a.tF && (a.tF = []);
      a.cD &&
        (y5(Lrb, function () {
          for (var c = g.u(a.cD), d = c.next(); !d.done; d = c.next())
            (d = d.value), d();
        }),
        (a.cD = []));
    },
    ...
    Qrb = function (a, b) {
      if (!a.C && b) {
        ...
        try {
          ...
          var c, d;
          null == (d = D5.Gz) ||
            d.call(D5, null == (c = a.j) ? void 0 : c.bv, e);
        }
        E5.YH(a);
        a.el = null;
    ...
    Rrb = function (a) {
      if (a) {
        ...
        a.__instance &&
          ((b = a.__instance), Qrb(b, a), b instanceof C5 && b.G());
        for (b = 0; b < a.childNodes.length; b++) Rrb(a.childNodes[b]);
      }
    },
    Trb = function (a) {
      1 === Srb.push(a) &&
        requestAnimationFrame(function () {
          setTimeout(function () {
            ...
            for (var c = b.next(); !c.done; c = b.next()) {
              c = c.value;
              try {
                for (var d = 0; d < c.length; d++) Rrb(c[d]);
              } catch (e) {
                (d = c = void 0),
                  null == (d = (c = D5).Gz) || d.call(c, "unknown", e);
              }
            }
          });
        });
    ...
    Urb = function (a, b) {
      ...
      b = null != (d = b) ? d : {};
      d = {};
      return (d.type = a), (d.props = b), (d.children = c), (d[F5] = !0), d;
    },
    Vrb = function (a) {
      return a.children;
    },
    H5 = function (a, b) {
      return G5.apply(null, [a, b].concat(g.qa(g.Ia.apply(2, arguments))));
    },
    I5 = function (a, b) {
      var c = G5;
      G5 = a;
    ...
    M5 = function (a) {
      return a instanceof g.Wd || a instanceof g.Zd || a instanceof g.ke || !1;
    },
    Wrb = function (a, b) {
      ...
      a.Ma ||
        ...
        1 === P5.size &&
          Promise.resolve().then(function () {
            for (var b = g.u(P5), c = b.next(); !c.done; c = b.next())
              (c = c.value), P5.delete(c), c.aG();
          }));
    },
    bsb = function (a, b, c) {
      var d = Grb(
    ...
    fsb = function (a) {
      var b = [];
      (({}).hnb ? dsb : csb)(function () {
        var c = b[0],
          d = b.Jq,
          e = I5(Q5, a);
        c = esb(c, e, b);
        Array.isArray(c) || (b.Jq = [c]);
        e = b.Jq;
        if (d) {
    ...
    esb = function (a, b, c) {
      ...
      if (null == a)
        return null == b
          ...
          : gsb(b, c);
      if (O5(a)) {
        if (null == b) return Wrb(a, J5());
        if (L5(b)) return Xrb(a, b);
        if (M5(b)) return Xrb(a, b.toString());
        if (O5(b)) return Wrb(a, b);
        if (0 === b.length) return Wrb(a, J5());
        b = gsb(b, c);
        Yrb([a], c.Jq);
        return b;
      }
      a = hsb(a);
      if (null == b) return N5(a, J5());
      if (L5(b)) return N5(a, K5(b));
      if (M5(b)) return N5(a, K5(b.toString()));
      if (O5(b)) return Yrb(a, [b])[0];
      if (0 === b.length) return N5(a, J5());
      b = gsb(b, c);
      Yrb(a, c.Jq);
      return b;
    },
    ...
    S5 = function (a, b, c, d, e) {
      ...
      if (O5(a)) return isb(b, a);
      if (Array.isArray(a)) {
        for (d = 0; d < a.length; d++) S5(a[d], b, c, a, d);
        return b;
      }
      if ("function" === typeof a)
        return (a = fsb(a)[0]), d && c && (d[e] = a), isb(b, a);
      if (null != a && a[F5]) {
        var f = a;
        a = I5(Q5, function () {
    ...
    ksb = function (a, b) {
      ...
      var e = z5(function (n) {
          d = n;
          c = I5(Q5, function () {
            return y5(jsb, function () {
              return a(b);
            });
          });
        }),
        f = null != c && c.Jq ? c.Jq : c,
    ...
    nsb = function (a, b, c) {
      if (
        Object.hasOwnProperty.call(lsb, a) &&
        ((a = lsb[a]),
    ...
    usb = function (a, b, c) {
      ...
      if (null == b ? 0 : b.el) {
        ...
        if ("function" === typeof d) d(a);
          ...
          var e;
          null == (e = d.Jaa) || e.call(d, a);
          a._disposeRef ||
            ((a._disposeRef = function () {
              var f;
              null == (f = d.Dba) || f.call(d);
    ...
    xsb = function (a, b) {
      if (a.Lob || a.bA) return !1;
      b || (b = {});
      var c = new C5(b);
      c.B = a;
      var d = y5(jsb, function () {
        return c.tx(b);
      });
    ...
    Fsb = function (a, b) {
      var c = Dsb("onChange"),
        d = Prb();
      Esb(c.Ug, b) &&
        ((c.Ug = b), (c.q_ = a), d.Gy || (d.Gy = []), d.Gy.push(c));
    },
    U5 = function (a, b) {
      Fsb(function () {
        return y5(null, a);
    ...
    V5 = function (a) {
      var b = [];
      if (e5()) return a();
      var c = Dsb("useMemoInternal");
      Esb(c.Ug, b) && ((c.Ug = b), (c.value = a()));
      return c.value;
    },
    W5 = function () {
      var a = V5(function () {
    ...
    Nsb = function (a, b, c) {
      ((void 0 === c ? 0 : c) ? Lsb : Msb)(a, function () {
        X5(b);
      });
    },
    X5 = function (a) {
      if (void 0 !== a && null !== a)
        if (Array.isArray(a)) {
        ...
        } else if (a instanceof g.Wd || a instanceof g.Zd || a instanceof g.ke)
          urb(a.toString());
        else if (O5(a)) {
          if (i5() !== a)
            throw Error(
          ...
          var c = typeof a;
          if ("boolean" === c || "number" === c || "string" === c) urb(a);
            ...
            if ("string" === typeof a.type) {
              a.xq || qrb(a.type, a.props.idomKey);
              d = h5;
              for (var h in a.props)
                a.props[h] !== Osb &&
                  ((e = a.props[h]), (f = p5), f.push(h), f.push(e));
              e = D5.attributes;
              e = void 0 === e ? Psb : e;
              f = h5;
              var l = g5(f),
                m = e;
              e = p5;
              l = l.j || (l.j = erb(e.length));
              for (var n = !l.length || !1, p = 0; p < e.length; p += 2) {
                h = e[p];
                if (n) l[p] = h;
                else if (l[p] !== h) break;
                var q = e[p + 1];
                if (n || l[p + 1] !== q) (l[p + 1] = q), trb(f, h, q, m);
              }
              if (p < e.length || p < l.length) {
                for (p = n = p; p < l.length; p += 2) Y5[l[p]] = l[p + 1];
                for (p = n; p < e.length; p += 2)
                  (n = e[p]),
                    ...
                    delete Y5[n];
                f5(l, e.length);
                for (b in Y5) trb(f, b, void 0, m), delete Y5[b];
              }
              b = Qsb;
              Qsb = f = r5.length;
              for (m = b; m < f; m += 5)
                (0, r5[m])(r5[m + 1], r5[m + 2], r5[m + 3], r5[m + 4]);
              Qsb = b;
              f5(r5, b);
              f5(e, 0);
              vsb(d, a.props);
              (a.props.skip || a.props.skipchildren) && h5.hasChildNodes()
                ? (l5 = h5.lastChild)
                : X5(a.children);
              k5(null);
              l5 = h5;
            ...
            if (a.type === Vrb) X5(a.children);
            else if (!Rsb(a)) {
              try {
                f = a.type;
                var r = f.bv;
                if (f === Ksb) (a.props.children = a.children), f(a.props);
                else {
                  ...
                  if (!m) {
                    ...
                    var w = a.props,
                      A;
                    if (
                      void 0 === (null == (A = f.prototype) ? void 0 : A.tx)
                    ) {
                      var C = new C5(w);
                      C.B = f;
                    } else C = new f(w);
                    C.j = f;
                    C.PM = { mQ: C.state, zP: !1 };
                    m = C;
                    m.props = null;
                    v && ((v.__instance = m), (m.el = v));
                  }
                  var F,
                    G = null != (F = m.PM) ? F : { mQ: m.state, zP: !1 },
                    L = G.zP,
                    M = G.mQ;
                  m.PM = void 0;
                  f.G7 && (M = f.G7(a.props, M));
                  b = !b && !L && !1;
                  m.props = a.props;
                  m.state = M;
                  if (b) l5 = h5.lastChild;
                  else {
                    b = m;
                    E5.TV(b);
                    var R = b.tx(b.props);
                    R
                      ...
                      : (q = void 0);
                    if ((b = q))
                      if (((b.xq = a.xq), (l = X5(b)), (a.xq = b.xq), !f.bv))
                        if (l)
                          (f.bv = l.tagName.toLowerCase()),
                            (l.__instance = m),
                            (m.el = l);
                        else if (null == (p = m.Lz) ? 0 : p.length)
                          null == (n = D5.Gz) ||
                            n.call(
                              D5,
                              "unknown",
                ...
                (b = ea),
                  null == (e = D5.Gz) ||
                    e.call(D5, null == (d = a.type) ? void 0 : d.bv, b);
              }
              a.xq && (k5(null), (l5 = h5), (h5 = h5.parentNode), (a.xq = !1));
            }
          }
        }
    },
    Rsb = function (a) {
      ...
      var c,
        ...
        e;
      if (i5() && (null == (e = i5()[R5]) ? void 0 : e.key) === d) {
        d = i5();
        c = d[R5];
        if (!c)
          throw Error(
        ...
        if (!b.G1) {
          for (b = 0; b < c.BZ; b++) l5 = i5();
          var f;
          null == (f = c.rqb) || f.call(c, a.props);
          return !0;
        }
        f = s5;
        b = b.G1(a.props, c.props, null !== f ? f : c.owner, c.M8);
        a = a.props;
        if ((c = c.props))
          (c.children = a.children), (c.b7 = a.b7), (c.fallback = a.fallback);
        X5(b);
        return !0;
      }
      a = ksb(a.type, a.props);
      a = null != a && a.Jq ? a.Jq : a;
      a = Array.isArray(a) ? a : [a];
      a = g.u(a);
      for (b = a.next(); !b.done; b = a.next())
        h5.insertBefore(b.value, i5()), (l5 = i5());
      return !0;
    },
    Ssb = function (a) {
      var b = Prb(),
      ...
      return [
        c.value,
        function (d) {
          if (null !== B5) throw Error("Can't set state during rendering");
          c.value = "function" === typeof d ? d(c.value) : d;
          b.PM = { mQ: b.state, zP: !0 };
          t5(b.dI, function () {
            I5(Urb, function () {
              if (b.el) {
                var e,
                ...
                try {
                  ...
                  var l, m;
                  null == (m = D5.Gz) ||
                    m.call(D5, null == (l = b.j) ? void 0 : l.bv, n);
                }
              }
            });
          });
    ...
    Xsb = function (a) {
      ...
      Wsb ||
        (b(function () {
          for (var c = g.u(Vsb), d = c.next(); !d.done; d = c.next())
            (d = d.value), d();
          Vsb.length = 0;
          Wsb = !1;
        }),
    ...
    Zsb = function (a) {
      ...
      var c = g.u(Ssb("Hide more videos")),
        d = c.next().value,
        e = c.next().value;
      U5(
        function () {
      ...
      return H5(
        "button",
        {
          ...
          "aria-label": d,
          "on:click": Jsb(function () {
            a.action && a.action();
          }),
        },
        H5("div", { class: "ytp-collapse-icon", el: h, skip: !0 })
      );
    },
    $sb = function (a) {
      function b() {
      ...
      var c = g.u(Ysb("More videos")),
        d = c.next().value,
        e = c.next().value,
        f = W5();
      U5(
        function () {
          a.jB && (a.jB.value = f.value);
        },
        [a.jB]
      );
      U5(
    ...
    btb = function (a) {
      ...
      U5(
        function () {
          ...
          g.yv(w.getRootNode(), "ytp-pause-overlay-controls-hidden", A);
          return function () {
      ...
      var t = a.J;
      if (f)
        if ((g.yv(t.getRootNode(), "ytp-expand-pause-overlay", !e), e))
          l.value.focus();
        else {
          var v = p.value;
          g.i2(v);
    ...
    ctb = function (a) {
      ...
      this.api.L("embeds_web_enable_pause_overlay_rounding") &&
        g.uv(this.element, "ytp-error-overlay-round-corners");
      this.Y = a.D;
      g.O(this, this.title);
      ...
      this.previous.listen("click", this.D3, this);
      g.O(this, this.qa);
      for (var c = { Pz: 0 }; 16 > c.Pz; c = { Pz: c.Pz }, c.Pz++) {
        var d = new g.W({
          I: "a",
        ...
        g.zs(e, "transitionDelay", c.Pz / 20 + "s");
        this.G.T(
          e,
          "click",
          (function (f) {
            return function (h) {
              ...
              b.api.L(
                ...
                ? (b.api.logClick(b.j[l].element),
                  (l = m.Ok()),
                  (m = {}),
                  g.pWa(b.api, m, "emb_rel_err"),
                  (l = g.Mn(l, m)),
                  g.uU(l, b.api, h))
                : g.tU(h, b.api, b.Y, n || void 0) &&
                  b.api.Io(m.videoId, n, m.playlistId);
            };
          })(c)
        );
        this.j.push(d);
      ...
      this.next.listen("click", this.C3, this);
    ...
    etb = function (a) {
      ...
      g.yv(a.element, "ytp-scroll-min", 0 <= b);
      g.yv(a.element, "ytp-scroll-max", b <= c);
    },
    ftb = function (a) {
      for (var b = 0; b < a.suggestionData.length; b++) {
        ...
        if (
          ...
          var l = {};
          g.KT(a.api, "addEmbedsConversionTrackingParams", [l]);
          f = g.Mn(f, g.dP(l, "emb_rel_err"));
        }
        d.element.style.display = "";
        l = d.Fa("ytp-suggestion-title");
        g.Cv.test(c.title)
          ? (l.dir = "rtl")
          : g.zjb.test(c.title) && (l.dir = "ltr");
        l = d.Fa("ytp-suggestion-author");
        g.Cv.test(e) ? (l.dir = "rtl") : g.zjb.test(e) && (l.dir = "ltr");
        d.update({
          views_or_author: e,
    ...
    Z5 = function (a) {
      ...
      g.O(this, f);
      a.U().C ||
        ((this.j = new ctb(a)), this.j.Ja(this.element), g.O(this, this.j));
    ...
    gtb = function (a, b, c) {
      ...
      c = {};
      g.KT(a.api, "addEmbedsConversionTrackingParams", [c]);
      b = g.id(c) ? b : g.Mn(b, c);
      g.Me(b);
    },
    htb = function (a, b) {
    ...
    ktb = function (a, b) {
      var c = a.api.U(),
        d;
      b.reason &&
        (itb(b.reason) ? (d = g.GF(b.reason)) : (d = g.OV(g.FF(b.reason))),
        a.Kd(d, "content"));
      var e;
      b.subreason &&
        (itb(b.subreason)
          ? (e = g.GF(b.subreason))
          : (e = g.OV(g.FF(b.subreason))),
        a.Kd(e, "subreason"));
      if (b.proceedButton && b.proceedButton.buttonRenderer) {
        ...
        if (
          ...
          ((e = b.text.simpleText),
          (f.textContent = e),
          !jtb(d, e) && (!c.C || c.embedsErrorLinks))
        ) {
          var h;
          c =
        ...
        V: [
          {
            ...
            V: [
              ...
              { I: "div", S: "ytp-impression-link-logo", V: [Zqb()] },
            ],
          },
        ],
      });
    ...
    ltb = function (a) {
      var b = {};
      g.KT(a.api, "addEmbedsConversionTrackingParams", [b]);
      return g.Mn(a.api.getVideoUrl(), g.dP(b, "emb_imp_woyt"));
    },
    a6 = function (a) {
      g.W.call(this, {
        I: "div",
    ...
    c6 = function (a) {
      ...
      g.W.call(this, {
        ...
        X: {
          target: b.Y,
          href: "{{url}}",
          "aria-label": g.JJ("Watch on $WEBSITE", { WEBSITE: g.UR(b) }),
      ...
      this.T(a, "videodatachange", this.K1);
    ...
    otb = function (a) {
      ...
      this.C = new g.lv(this.L8, 4e3, this);
      this.B = !1;
      a.createClientVe(this.element, this, 39306);
      this.T(a, "presentingplayerstatechange", this.dM);
      ...
      this.hide();
      g.OT(a.app) && (mtb(this), this.dM(), ntb(this));
      g.O(this, this.C);
    },
    ntb = function (a) {
    ...
    mtb = function (a) {
      a.watermark ||
        ...
        g.yv(a.watermark.element, "ytp-muted-autoplay-watermark", !0),
    ...
    d6 = function (a) {
      ...
      "0" === a.U().controlsType &&
        g.uv(a.getRootNode(), "ytp-pause-overlay-controls-hidden");
      this.api.L("embeds_web_enable_pause_overlay_rounding") &&
        g.uv(this.element, "ytp-pause-overlay-round-corners");
      g.O(this, this.C);
      g.O(this, this.D);
      var c = new g.W({
        I: "button",
    ...
    utb = function (a) {
      ...
      if (
        ...
        a.J.L("embeds_web_enable_keto_pause_overlay")
          ? ((b = a.G.element), (c = H5(btb, { J: a.J, Se: c })), Nsb(b, c, !1))
          : ((a.C = new d6(a.J, c)), g.O(a, a.C), a.C.Ja(a.G.element));
        g.cU(a.J, a.G.element, 4);
        ttb(a, a.J.Qb());
      }
    },
    ttb = function (a, b) {
    ...
    rtb = function (a) {
      var b = a.J;
      a = !!b.Yc();
      g.yv(b.getRootNode(), "ytp-shorts-mode", a);
      if ((b = b.getVideoData())) b.oV = a;
    },
    g6 = function (a, b) {
      var c = a.J.U();
      a = {
        ...
        embedUrl: g.Gfa(a.J.U().loaderUrl),
        eventType: b,
        youtubeHost: g.hn(a.J.U().Ga) || "",
      };
      a.embeddedPlayerMode = c.Da;
      g.KC("embedsAdEvent", a);
    };
  var d5 = [],
    crb = Symbol("comp_stack_added");
  var grb = Object.prototype.hasOwnProperty;
  drb.prototype = Object.create(null);
  var Psb = jrb();
  var q5 = null;
  var rrb =
  ...
  var vtb = Symbol("UNSET"),
    wtb = Symbol("COMPUTING"),
    xtb = Symbol("ERRORED");
  Object.assign({}, x5, {
    value: vtb,
    Zl: !0,
    ...
    PW: vrb,
    K_: function (a) {
      return a.value === vtb || a.value === wtb;
    },
    L_: function (a) {
      if (a.value === wtb) throw Error("Detected cycle in computations.");
      var b = a.value;
      a.value = wtb;
      var c = yrb(a);
      try {
      ...
      b !== vtb && b !== xtb && d !== xtb && a.PW(b, d)
        ? (a.value = b)
        : ((a.value = d), a.version++);
    },
  });
  Object.assign({}, x5, { PW: vrb, value: void 0 });
  var Drb = Object.assign({}, x5, {
    qW: !0,
    GN: !1,
    rW: function (a) {
      null !== a.schedule && a.schedule(a.jB);
    },
    eY: !1,
    Ry: Erb,
  });
  ...
  var jsb = Hrb(!0);
  var Nrb = {};
  var F5 = Symbol("IS_VNODE");
  A5.prototype.jD = function () {};
  A5.prototype.P6 = function () {};
  A5.prototype.YH = function () {};
  A5.prototype.Q6 = function () {};
  var B5 = null;
  g.y(C5, A5);
  C5.prototype.tx = function (a) {
    var b = this,
      c = B5;
    B5 = this;
    $qb(this.B);
  ...
  var msb = {
    ...
    lsb = {
      ...
      area: { href: [{ Bd: 3 }] },
      audio: { src: [{ Bd: 3 }] },
      button: { formaction: [{ Bd: 3 }], formmethod: [{ Bd: 1 }] },
      form: { action: [{ Bd: 3 }], method: [{ Bd: 1 }] },
      iframe: { srcdoc: [{ Bd: 2 }] },
      img: { src: [{ Bd: 3 }] },
      input: {
        accept: [{ Bd: 1 }],
      ...
      link: {
        href: [
          { Bd: 3, ji: "rel", Ei: "alternate" },
          { Bd: 3, ji: "rel", Ei: "author" },
          { Bd: 3, ji: "rel", Ei: "bookmark" },
          { Bd: 3, ji: "rel", Ei: "canonical" },
          { Bd: 3, ji: "rel", Ei: "cite" },
          { Bd: 3, ji: "rel", Ei: "help" },
          { Bd: 3, ji: "rel", Ei: "icon" },
          { Bd: 3, ji: "rel", Ei: "license" },
          { Bd: 3, ji: "rel", Ei: "next" },
          { Bd: 3, ji: "rel", Ei: "prefetch" },
          { Bd: 3, ji: "rel", Ei: "dns-prefetch" },
          { Bd: 3, ji: "rel", Ei: "prerender" },
          { Bd: 3, ji: "rel", Ei: "preconnect" },
          { Bd: 3, ji: "rel", Ei: "preload" },
          { Bd: 3, ji: "rel", Ei: "prev" },
          { Bd: 3, ji: "rel", Ei: "search" },
          { Bd: 3, ji: "rel", Ei: "subresource" },
        ],
      },
      script: { defer: [{ Bd: 1 }] },
      source: { src: [{ Bd: 3 }] },
      textarea: { readonly: [{ Bd: 1 }] },
      video: { src: [{ Bd: 3 }] },
    };
  var ytb = /^(?!javascript:)(?:[a-z0-9+.-]+:|[^&:\/?#]*(?:[\/?#]|$))/i,
    h6 = {},
    osb =
      ((h6[1] = { Hq: null, Ht: null, Wr: null }),
      (h6[2] = {
        Hq: function () {
      ...
      (h6[3] = {
        Hq: function (a, b, c) {
          return ytb.test(c) ? c : g.ee.toString();
        },
        Ht: function (a) {
      ...
      (h6[7] = { Hq: null, Ht: null, Wr: null }),
      (h6[8] = { Hq: null, Ht: null, Wr: null }),
      (h6[10] = { Hq: null, Ht: null, Wr: null }),
      h6);
  var ztb = jrb(),
    ssb = ztb.__default,
    tsb = ztb.style,
    rsb = ["focusin", "focusout"];
  Q5 = zsb;
  (function (a) {
    var b = {},
      c;
    for (c in a)
      (b = { D_: void 0, uZ: void 0 }),
        (b.D_ = E5[c]),
        (b.uZ = a[c]),
        (E5[c] = (function (d) {
          return function () {
            var e = g.Ia.apply(0, arguments);
            d.D_.apply(null, g.qa(e));
            d.uZ.apply(null, g.qa(e));
          };
        })(b));
  })({
    TV: function (a) {
      t5(a.dI, function () {
        var b;
        (null == (b = a.Gy) ? 0 : b.length) && Isb(a.Gy);
      });
    },
    jD: function (a) {
      t5(a.dI, function () {
    ...
    YH: function (a) {
      var b;
      (null == (b = a.Lz) ? 0 : b.length) && a.Lz.forEach(Hsb);
    },
  });
  Q5 = zsb;
  var Atb = {},
    Btb =
      ((Atb.__default = function () {
        return T5;
      }),
      (Atb.style = function () {
        return T5;
      ...
      Atb),
    i6;
  for (i6 in Btb) D5.attributes[i6] = Btb[i6](D5.attributes[i6]);
  var Vsb = [],
    Wsb = !1;
  g.y(ctb, g.W);
  g.k = ctb.prototype;
  ...
  g.k.resize = function (a, b) {
    ...
    if (150 >= Math.min(a.width, a.height) || 0 === h || !c.wd) this.hide();
      ...
      b &&
        ...
        (m = a / l - this.B),
        (q = Math.floor(m / d)));
      50 > m || g.$T(this.api) ? this.hide() : this.show();
      for (b = 0; b < h; b++) {
        d = this.j[b];
  ...
  g.k.onVideoDataChange = function () {
    ...
    this.Y = a.If ? !1 : b.D;
    a.suggestions
      ? (this.suggestionData = g.Ht(a.suggestions, function (c) {
  ...
  Z5.prototype.show = function () {
    g.NV.prototype.show.call(this);
    htb(this, this.api.kb().getPlayerSize());
  };
  Z5.prototype.resize = function (a) {
    g.NV.prototype.resize.call(this, a);
    this.j &&
      (htb(this, a),
      g.yv(
        this.element,
  ...
  Z5.prototype.B = function (a) {
    g.NV.prototype.B.call(this, a);
    var b = this.api.getVideoData();
    if (b.AC || b.playerErrorMessageRenderer)
      (a = b.AC)
        ? ktb(this, a)
        : b.playerErrorMessageRenderer &&
          ktb(this, b.playerErrorMessageRenderer);
    else {
      var c;
      a.un &&
        (b.uy
  ...
  $5.prototype.j = function () {
    ...
    d || f || c || e || b || this.api.Yc() || !a.videoId
      ? (this.hide(), this.api.logVisibility(this.element, !1))
      : ((a = ltb(this)), this.updateValue("url", a), this.show());
  };
  ...
  a6.prototype.hk = function () {
    var a = this.api.Qb();
    !this.api.Vh() || (g.kG(a, 2) && g.WT(this.api)) || g.kG(a, 64)
  ...
  b6.prototype.C = function () {
    ...
    this.api.getVideoData().mutedAutoplay &&
      (g.kG(a, 2) && !this.Eb
        ? (this.show(),
          this.j ||
            ((this.j = new g.LV(this.api)),
            g.O(this, this.j),
            this.j.Ja(this.D, 0),
            this.j.show()),
          (a = this.api.getVideoData()),
          this.updateValue("text", a.mT),
          g.yv(this.element, "ytp-muted-autoplay-show-end-panel", !0),
          this.api.logVisibility(this.element, this.Eb),
  ...
  b6.prototype.onClick = function () {
    if (!this.B) {
      ...
      g.yv(this.api.getRootNode(), "ytp-muted-autoplay", !1);
      var a = this.api.getVideoData(),
  ...
  g.k.onVideoDataChange = function () {
    var a = this.api.U();
    a.C && g.uv(this.element, "ytp-no-hover");
  ...
  g.k.onClick = function (a) {
    ...
    if (
      ...
      var c = {};
      g.KT(this.api, "addEmbedsConversionTrackingParams", [c]);
      b = g.Mn(b, g.dP(c, "emb_yt_watermark"));
    }
    g.uU(b, this.api, a);
    this.api.L("web_player_log_click_before_generating_ve_conversion_params") ||
      this.api.logClick(this.element);
  ...
  d6.prototype.hide = function () {
    g.wv(this.api.getRootNode(), "ytp-expand-pause-overlay");
    g.W.prototype.hide.call(this);
  };
  ...
  g.k.create = function () {
    ...
    d && g.zH({ clientPlaybackNonce: d });
    a.Za && utb(this);
    this.Z = new otb(this.J);
    g.O(this, this.Z);
    g.cU(this.J, this.Z.element, 4);
    this.ra = new b6(this.J);
    g.O(this, this.ra);
    g.cU(this.J, this.ra.element, 4);
    a.Ld &&
      ((this.watermark = new c6(this.J)),
      g.O(this, this.watermark),
      g.cU(this.J, this.watermark.element, 8));
    b &&
      ((this.K = new $5(this.J, b)),
      g.O(this, this.K),
      g.cU(this.J, this.K.element, 8),
      g.OT(this.J.app) && (this.onMutedAutoplayStarts(), this.K.hide()));
    a.B &&
      ((this.qa = new a6(this.J)),
      g.O(this, this.qa),
      g.cU(this.J, this.qa.element, 4));
    ...
    if ((this.N = g.ZB(g.QR(a))))
      (this.countdownTimer = new e6(this.J)),
        g.O(this, this.countdownTimer),
        g.cU(this.J, this.countdownTimer.element, 4),
    ...
    (null == (e = this.J.U().getWebPlayerContextConfig())
      ...
      (a = g.aB("IDENTITY_MEMENTO")) &&
      this.J.Dm("onMementoChange", a);
  };
  g.k.onCueRangeEnter = function (a) {
    "countdown timer" === a.getId() &&
      this.countdownTimer &&
      (this.countdownTimer.show(), qtb(this.countdownTimer));
  };
  ...
  g.k.Ac = function (a) {
    g.kG(a, 128)
      ? (this.vg ||
          ((this.vg = new Z5(this.J)),
          g.O(this, this.vg),
          g.cU(this.J, this.vg.element, 4)),
        this.vg.B(a.Hg),
        this.vg.show(),
        g.uv(this.J.getRootNode(), "ytp-embed-error"))
      : this.vg &&
        (this.vg.dispose(),
        (this.vg = null),
        g.wv(this.J.getRootNode(), "ytp-embed-error"));
    if (this.countdownTimer && this.countdownTimer.j)
      if (g.kG(a, 64)) this.countdownTimer.hide(), f6(this.countdownTimer);
      else if (a.isPaused()) {
