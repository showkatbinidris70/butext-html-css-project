    ...
    buildPlayer: function (options) {
      return this.each(function () {
        ...
        var property =
          ...
          "string" == typeof jQueryYTPlayer.data("property")
        ...
        (YTPlayer.canGoFullScreen = !(
          ...
          jQueryYTPlayer.attr("id") ||
            jQueryYTPlayer.attr("id", "video_" + new Date().getTime());
              ...
              if (
                ...
                eval(YTPlayer.opt.stopMovieOnBlur) &&
                  (document.hasFocus()
                    ...
                    : 1 == YTPlayer.state &&
                      ((YTPlayer.hasFocus = !1), jQueryYTPlayer.YTPPause())),
                YTPlayer.controlBar &&
